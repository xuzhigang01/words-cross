这是一个Go语言写的Crossed words building示例代码，实现了：交叉单词—生成及展示

同样的逻辑，[这里是JAVA实现](https://github.com/xuzhigang01/words-cross_java)

在代码目录下go run main.go，然后在浏览器中访问localhost:8080，如：
